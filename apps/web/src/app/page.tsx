                ...
                {classes.length > 1 ? (
                  <div className="flex flex-col items-end">
                    ...
                    <select
                      ...
                      className="select select-sm bg-base-100 border-2 border-base-content/10 hover:border-primary/50 focus:border-primary text-sm font-medium text-base-content min-w-[180px]"
                    >
                      {classes.map((classItem) => (
                        <option key={classItem.id} value={classItem.id}>
                          {classItem.label}
